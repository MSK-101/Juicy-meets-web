...
import { mockVideoChatService } from '@/services/mockVideoChatService';

export const MockVideoChat: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      // Cleanup on unmount
      mockVideoChatService.leaveChat();
    };
  }, []);
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      const localStream = await mockVideoChatService.getLocalStream();
  ...
  const handleStop = async () => {
    try {
      await mockVideoChatService.leaveChat();
      setStatus('idle');
      setError(null);
      ...
      case 'idle':
        return (
          <div className="text-center p-8">
            <h2 className="text-2xl font-bold mb-4">Mock Video Chat</h2>
            <p className="text-gray-600 mb-2">Test WebRTC without backend</p>
            <p className="text-sm text-gray-500 mb-6">Will automatically find a &quot;match&quot; after 2 seconds</p>
            <button
              onClick={handleStart}
      ...
      case 'waiting':
        return (
          <div className="text-center p-8">
            ...
            <p className="text-sm text-gray-500 mb-4">(Mock will connect in ~2 seconds)</p>
            <button
              onClick={handleStop}
      ...
      case 'connected':
        return (
          <div className="text-center p-4">
            ...
            <p className="text-sm text-gray-500 mb-2">Connection: {connectionState}</p>
            <p className="text-xs text-blue-500 mb-4">(Remote video is mirrored local for demo)</p>
            <button
              onClick={handleStop}
              className="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg"
            >
    ...
    <div className="flex flex-col h-screen bg-gray-900 text-white">
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 relative bg-gray-800">
          ...
          />
          {!mockVideoChatService.getRemoteStream() && (
